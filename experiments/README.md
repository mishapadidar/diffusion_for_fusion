# Experiments
Each subdirectory contains the scripts used to make plots for the paper.

- `conditional_diffusion` contains the scripts used to train the conditional diffusion model.
