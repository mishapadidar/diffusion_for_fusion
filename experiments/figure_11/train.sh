...
# python train_model.py --learning_rate 5e-4 --num_epochs 10000 --time_embedding "sinusoidal" --hidden_size 1024  --hidden_layers 3 --embedding_size 64 --train_batch_size 640 --save_images_step 100 --num_timesteps 600